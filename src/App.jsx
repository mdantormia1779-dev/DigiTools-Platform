      ...
      <div>
        ...
        <div className="tabs bg-transparent justify-center mb-4">
          <div className='border-gray-400 border-2 rounded-full text-black'>
            ...
            <input onClick={() => setActive("Cart")} type="radio" name="my_tabs_1" className={`rounded-full tab w-30 ${active === "Cart" ? "bg-[#9514FA] text-white" : "bg-white text-black"}"}`} aria-label={`Cart (${cart.length})`} />
          </div>
        </div>
      </div>
      {
