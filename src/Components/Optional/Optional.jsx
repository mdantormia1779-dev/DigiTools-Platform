    ...
    return (
        <div className='bg-[#4F39F6]'>
            <div className='container mx-auto py-32'>
                <h1 className='mb-4 text-white font-extrabold text-4xl text-center'>Ready to Transform Your Workflow?</h1>
                ...
                <div className='flex justify-center items-center'>
                    ...
                    <button className='btn bg-transparent border-white ml-4 text-white font-semibold rounded-full'><p>View Pricing</p></button>
                </div>
